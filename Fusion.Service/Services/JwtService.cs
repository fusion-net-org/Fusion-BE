    ...
    public async Task<(string AccessToken, string RefreshToken)> GenerateTokensAsync(User user)
    {
       if(user == null)
        ...
        var accessToken = new JwtSecurityToken(
            ...
            claims: claims, expires: DateTime.UtcNow.AddMinutes(int.Parse(jwtSettings["AccessTokenExpiresInMinutes"]!)),
        ...
        var refreshToken = new RefreshToken {
            UserId = user.Id, Token = Convert.ToBase64String(RandomNumberGenerator.GetBytes(64)),
