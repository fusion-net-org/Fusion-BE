...
namespace Fusion.Repository.Repositories
{
    public class UserRepository : GenericRepository<User>, IUserRepository
    {
        ...
        public async Task<PagedResult<User>> GetPagedAdminUsersAsync(AdminUserPagedSearch request, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PagedResult<User>> GetPagedCompanyUsersAsync(CompanyUserPagedSearch request, CancellationToken cancellationToken = default)
        {
            var query = _dbSet.AsQueryable();
