...
namespace Fusion.Repository.Migrations
{
    ...
    [Migration("20251112160354_Update_Table_SubscriptionPlan_V1")]
    partial class Update_Table_SubscriptionPlan_V1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fusion.Repository.Entities.Feature", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "UX_Features_Code_Unique")
                        .IsUnique()
            ...
            modelBuilder.Entity("Fusion.Repository.Entities.SubscriptionPlanFeature", b =>
                {
                    ...
                    b.HasIndex(new[] { "PlanId", "FeatureId" }, "UX_SubscriptionPlanFeature_Unique")
                        .IsUnique()
                        .HasFilter("([plan_id] IS NOT NULL AND [feature_id] IS NOT NULL)");
            ...
            modelBuilder.Entity("Fusion.Repository.Entities.SubscriptionPlan", b =>
                {
                    b.HasOne("Fusion.Repository.Entities.SubscriptionPlanPrice", "Prices")
                        .WithMany()
            ...
            modelBuilder.Entity("Fusion.Repository.Entities.SubscriptionPlanFeature", b =>
                {
                    b.HasOne("Fusion.Repository.Entities.Feature", "Features")
                        .WithMany("PlanFeatures")
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SubscriptionPlanFeature_Feature");
                    ...
                    b.HasOne("Fusion.Repository.Entities.SubscriptionPlan", "SubscriptionPlans")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SubscriptionPlanFeature_Plan");
            ...
            modelBuilder.Entity("Fusion.Repository.Entities.SubscriptionPlanPrice", b =>
                {
                    b.HasOne("Fusion.Repository.Entities.SubscriptionPlan", "SubscriptionPlans")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SubscriptionPlanPrice_Plan");
